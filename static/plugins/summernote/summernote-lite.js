...
function () {
  ...
  History_createClass(History, [{
    ...
    */
    ...
    /**
    *  @method commit
    *  Resets history stack, but keeps current editor's mainContent.
    */
...
function () {
  ...
  Editor_createClass(Editor, [{
    ...
    value: function initialize() {
      ...
      } // init mainContent before set event
  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      this.$dropzone.on('drop', function (event) {
        var dataTransfer = event.originalEvent.dataTransfer; // stop the browser from opening the dropped mainContent
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    value: function initialize() {
      this.$popover = this.ui.popover({
        ...
        callback: function callback($node) {
          var $content = $node.find('.popover-mainContent,.note-popover-mainContent');
          $content.prepend('<span><a target="_blank"></a>&nbsp;</span>');
        }
      }).render().appendTo(this.options.container);
      var $content = this.$popover.find('.popover-mainContent,.note-popover-mainContent');
...
function () {
  ...
  AirPopover_createClass(AirPopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-mainContent');
...
function () {
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function initialize() {
      ...
      this.$popover.hide();
      this.$content = this.$popover.find('.popover-mainContent,.note-popover-mainContent');
...
function () {
  function TooltipUI($node, options) {
    ...
    this.$tooltip = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"/>', '<div class="note-tooltip-mainContent"/>', '</div>'].join('')); // define event
  ...
  _createClass(TooltipUI, [{
    ...
    value: function show() {
      ...
      $tooltip.find('.note-tooltip-mainContent').text(title);
...
var dialog = renderer["a" /* default */].create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="note-modal-mainContent">', options.title ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon-close"></i></button><h4 class="note-modal-title">' + options.title + '</h4></div>' : '', '<div class="note-modal-body">' + options.body + '</div>', options.footer ? '<div class="note-modal-footer">' + options.footer + '</div>' : '', '</div>'].join(''));
...
var popover = renderer["a" /* default */].create(['<div class="note-popover bottom">', '<div class="note-popover-arrow"/>', '<div class="popover-mainContent note-children-container"/>', '</div>'].join(''), function ($node, options) {
...
var ui = function ui(editorOptions) {
  return {
    ...
    /**
     * get popover mainContent area
     *
     * @param $popover
     * @returns {*}
     */
    getPopoverContent: function getPopoverContent($popover) {
      return $popover.find('.note-popover-mainContent');
    },
