...
/* A rectangular panel that is absolutely positioned over other mainContent
------------------------------------------------------------------------------------------------------------------------
Options:
  - className (string)
  - mainContent (HTML string, element, or element array)
  - parentEl
  - top
  - left
...
var Popover = /** @class */ (function () {
    ...
    // Creates `this.el` and renders mainContent inside of it
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
        ...
        // append to each row's mainContent skeleton
        this.dayGrid.rowEls.forEach(function (rowNode, i) {
            rowNode.querySelector('.fc-mainContent-skeleton > table').appendChild(rowStructs[i].tbodyEl);
        });
    ...
    // Uses the given events array to generate <tbody> elements that should be appended to each row's mainContent skeleton.
    ...
    DayGridMirrorRenderer.prototype.attachSegs = function (segs, mirrorInfo) {
        ...
        this.dayGrid.rowEls.forEach(function (rowNode, row) {
            ...
            if (sourceSeg && sourceSeg.row === row) {
                ...
                skeletonTopEl = rowNode.querySelector('.fc-mainContent-skeleton tbody');
                if (!skeletonTopEl) { // when no events
                    skeletonTopEl = rowNode.querySelector('.fc-mainContent-skeleton table');
                }
            }
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderDayRowHtml = function (row, isRigid) {
        ...
        return '' +
            ...
            '</table>' +
            '</div>' +
            '<div class="fc-mainContent-skeleton">' +
            '<table>' +
    ...
    // Generates the HTML for the <td>s of the "number" row in the DayGrid's mainContent skeleton.
...
var AbstractDayGridView = /** @class */ (function (_super) {
    ...
    function AbstractDayGridView() {
        ...
        /* Day Grid Rendering
        ------------------------------------------------------------------------------------------------------------------*/
        // Generates the HTML that will go before mainContent-skeleton cells that display the day/week numbers
