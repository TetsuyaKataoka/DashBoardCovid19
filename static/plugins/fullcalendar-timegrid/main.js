...
(function (global, factory) {
    ...
    */
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        /* Content Skeleton
        ------------------------------------------------------------------------------------------------------------------*/
        // Renders the DOM that the view's mainContent will live in
        TimeGrid.prototype.renderContentSkeleton = function () {
            ...
            skeletonEl = this.contentSkeletonEl = core.htmlToElement('<div class="fc-mainContent-skeleton">' +
                '<table>' +
                '<tr>' + parts.join('') + '</tr>' +
                '</table>' +
                '</div>');
            this.colContainerEls = core.findElements(skeletonEl, '.fc-mainContent-col');
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        function AbstractTimeGridView() {
            ...
            // Affects mainContent-skeleton, mirror-skeleton, highlight-skeleton for both the time-grid and day-grid.
