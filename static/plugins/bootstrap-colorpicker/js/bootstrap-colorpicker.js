...
exports.default = {
   ...
   * The trigger, mainContent and html options are always ignored.
   *
   * @type {boolean}
   * @default Object
   */
  ...
  /**
   * If true, the input mainContent will be replaced always with a valid color,
...
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    value: function createPopover() {
      ...
      cp.picker.addClass('colorpicker-bs-popover-mainContent');
