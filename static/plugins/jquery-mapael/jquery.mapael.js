...
(function (factory) {
    ...
    var Mapael = function (container, options) {
        ...
        // Save initial HTML mainContent (used by destroy method)
    ...
    Mapael.prototype = {
        ...
        destroy: function () {
            ...
            // Replace initial HTML mainContent
            self.$map.html(self.initialMapHTMLContent);

            // Empty legend containers and replace initial HTML mainContent
        ...
        elemEnter: function (elem) {
            ...
            if (elem.options && elem.options.tooltip !== undefined) {
                ...
                if (elem.options.tooltip.content !== undefined) {
                    // if tooltip.mainContent is function, call it. Otherwise, assign it directly.
